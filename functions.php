...
if ( ! function_exists( 'generate_setup' ) ) {
	...
	function generate_setup() {
		...
		// Inizio Rileva gli errori
		add_action('wp_head', function () {
    error_log('Notification Sound URL: ' . plugins_url('/sounds/notification.mp3', __FILE__));
});
       //Fine Rileva gli errori
...
/**
* Funzioni aggiuntive tinymce
*/
add_filter( 'wpforo_editor_settings', function( $settings ){
if ( empty( $settings['tinymce'] ) || ! is_array( $settings['tinymce'] ) )
$settings['tinymce'] = [];
$settings['plugins']             = 'compat3x,fullscreen,hr,paste,textcolor,lists,table,visualblocks,visualchars,insertdatetime,charmap,searchreplace,anchor,advlist,codesample,wordcount';
